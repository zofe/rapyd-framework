...
//todo fare un require di qualcosa per recuperare le costanti-path,  qui serve "application/storage/cache/img" 
...
define ('DIRECTORY_CACHE', '../../application/public/cache');		// cache directory
